...
define (function () {
	...
	proto = {
		imgs: {
			"field_bg"		: imgsFolder + "fields/grass-bg.png",
			"goals"			: imgsFolder + "goals-new.png",
			// "goal_post"		: imgsFolder + "goals-new.png",
			// "selected"		: imgsFolder + "d",
			"0"				: imgsFolder + "profiles/blue.png",
			"1"				: imgsFolder + "profiles/red.png",
			// "2"				: imgsFolder + "profiles/poland.png",
			// "3"				: imgsFolder + "profiles/usa.png",
			"ball"			: imgsFolder + "ball-new.png",
